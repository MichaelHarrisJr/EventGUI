...
public class ArtEventPane extends GridPane {
    ...
    protected ArtEventPane() {
        ...
        this.tfType    .setAlignment(Pos.BOTTOM_RIGHT);
        ...
        super.add(new Label("Audience:"         ), 0, 2); super.add(this.tfAudience, 1, 2); super.add(new Label("Type:"        ), 2, 2); super.add(this.tfType , 3, 2);
    ...
    public void submit() {
        ...
        String type  = this.tfType .getText().trim();
        ...
        try  {event = new ArtEvent(name, place, dateTime, audience, cost, revenue, profit, type);} catch (ParseException ex) {}
        ...
        super.add(this.lblWeekEnd , 0, 4);
        super.add(this.hBoxWeekEnd, 1, 4);
        super.add(new Label("Profit:"        ), 2, 5); super.add(this.tfType , 3, 5);
